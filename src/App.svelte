...
<section style="padding: 2em 0;">
  <Tabs>
    <TabLabel bind:group={activeTab} value={1}>Equipment Availability</TabLabel>
...
<Accordian>
  ...
  <AccordianItem>
    <svelte:fragment slot="title">Effortless Equipment Tracking</svelte:fragment>
    <article>
      <p>
        When checking out/checking in an equipment, record the equipment's
        location through a simple check-in and checkout procedure, ensuring
  ...
  <AccordianItem>
    <svelte:fragment slot="title">Equipment Reservation Calendar</svelte:fragment>
    <article>
      <p>
        Schedule and reserve equipment in a shared calendar for organized
        allocation and planning. You can schedule it for test requests/events.
      </p>
      <img
        src="https://static.wixstatic.com/media/454d4b_66eda8b1a25e46d9bee1622d73a6f0bd~mv2.png"
        alt="Equipment Reservation Calendar"
  ...
  <AccordianItem>
    ...
    <article>
      <p>
        Plan ad hoc maintenance or calibration schedules in advance and receive
        timely notifications, preventing unexpected breakdowns and reducing
        downtime.
      </p>
      <img
        src="https://static.wixstatic.com/media/454d4b_d8076718904843b88c5a41ab9f78b39d~mv2.png"
  ...
  <AccordianItem>
    <svelte:fragment slot="title">Preventive Maintenance Logs</svelte:fragment>
    <article>
      <p>
        Reminder for the upcoming calibration events and keeping all records of
  ...
  <AccordianItem>
    ...
    <article>
      <p>
        Easily assists Overall Equipment Effectiveness (OEE) and track usage
        records, empowering you to optimize and forecast your asset performance.
      </p>
      <img
        src="https://static.wixstatic.com/media/454d4b_7e85dafae2004557b0a4ba159035b9a6~mv2.png"
        alt="Utilization Record"
  ...
  <AccordianItem>
    <svelte:fragment slot="title">Equipment Details Management</svelte:fragment>
    <article>
      <p>
        Centralize and update equipment data, including name, type, specs,
        purchase details, manufacturer, supplier, and warranty information for
  ...
  <AccordianItem>
    <svelte:fragment slot="title">Clone and Archive Equipment</svelte:fragment>
    <article>
      <p>
        Effortlessly duplicate equipment profiles, simplify additions, and
        streamline retirement with preserved records and archives for efficient
  ...
  <AccordianItem>
    <svelte:fragment slot="title">Overdue Checked-Out Equipment</svelte:fragment>
    <article>
      <p>
        Receive alerts for overdue equipment checkouts, ensuring equipment is
        returned on time and avoiding unnecessary delays.
      </p>
      <img
        src="https://static.wixstatic.com/media/454d4b_9e1a320933fc4c498aecfe79fbaa6d17~mv2.png"
        alt="Overdue Checked-Out Equipment"
  ...
  <AccordianItem>
    <svelte:fragment slot="title">Barcode Printing for Identification</svelte:fragment>
    <article>
      <p>
        Generate unique barcodes for each piece of equipment, simplifying
        identification and tracking of warranty, calibration, and other
